...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $statement = $pdo->prepare("UPDATE friday_schedule SET image1=? WHERE friday_schedule_id=1");
...
if(isset($_POST['form7'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE friday_schedule SET image4=? WHERE friday_schedule_id=1");
        $statement->execute(array($final_name));
        $success_message = 'schedule image is succesfully updated.';
...
if(isset($_POST['form9'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE friday_schedule SET image5=? WHERE friday_schedule_id=1");
        $statement->execute(array($final_name));
        $success_message = 'schedule image is succesfully updated.';
...
if(isset($_POST['form11'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE friday_schedule SET image6=? WHERE friday_schedule_id=1");
        $statement->execute(array($final_name));
        $success_message = 'schedule image is succesfully updated.';
...
if(isset($_POST['form13'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE friday_schedule SET image7=? WHERE friday_schedule_id=1");
        $statement->execute(array($final_name));
        $success_message = 'schedule image is succesfully updated.';
...
if(isset($_POST['form15'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE friday_schedule SET image8=? WHERE friday_schedule_id=1");
        $statement->execute(array($final_name));
        $success_message = 'schedule image is succesfully updated.';
...
if(isset($_POST['form2'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE friday_schedule SET time1=?, class1=?, name1=? WHERE friday_schedule_id=1");
...
if(isset($_POST['form4'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE friday_schedule SET time2=?, class2=?, name2=? WHERE friday_schedule_id=1");
...
if(isset($_POST['form6'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE friday_schedule SET time3=?, class3=?, name3=? WHERE friday_schedule_id=1");
...
if(isset($_POST['form8'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE friday_schedule SET time4=?, class4=?, name4=? WHERE friday_schedule_id=1");
...
if(isset($_POST['form10'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE friday_schedule SET time5=?, class5=?, name5=? WHERE friday_schedule_id=1");
...
if(isset($_POST['form12'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE friday_schedule SET time6=?, class6=?, name6=? WHERE friday_schedule_id=1");
...
if(isset($_POST['form14'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE friday_schedule SET time7=?, class7=?, name7=? WHERE friday_schedule_id=1");
...
if(isset($_POST['form16'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE friday_schedule SET time8=?, class8=?, name8=? WHERE friday_schedule_id=1");
