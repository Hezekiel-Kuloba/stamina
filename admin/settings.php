...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $statement = $pdo->prepare("SELECT * FROM websitetools_settings WHERE tools_id=2");
        $statement->execute();
        ...
        $statement = $pdo->prepare("UPDATE websitetools_settings SET logo=? WHERE tools_id=2");
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE websitetools_settings SET favicon=? WHERE tools_id=2");
        $statement->execute(array($final_name));
...
if(isset($_POST['form3'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE websitetools_settings SET  footer_copyright=?, contact_address=?, contact_email=?, contact_phone=? WHERE id=2");
...
if(isset($_POST['form6'])) {
    // updating the database
    $statement = $pdo->prepare("UPDATE websitetools_settings SET meta_title_home=?, meta_keyword_home=?, meta_description_home=? WHERE id=1");
