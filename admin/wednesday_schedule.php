...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $statement = $pdo->prepare("UPDATE wednesday_schedule SET image1=? WHERE wednesday_schedule_id=1");
...
if(isset($_POST['form7'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE wednesday_schedule SET image4=? WHERE wednesday_schedule_id=1");
        $statement->execute(array($final_name));
        $success_message = 'schedule image is succesfully updated.';
...
if(isset($_POST['form9'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE wednesday_schedule SET image5=? WHERE wednesday_schedule_id=1");
        $statement->execute(array($final_name));
        $success_message = 'schedule image is succesfully updated.';
...
if(isset($_POST['form11'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE wednesday_schedule SET image6=? WHERE wednesday_schedule_id=1");
        $statement->execute(array($final_name));
        $success_message = 'schedule image is succesfully updated.';
...
if(isset($_POST['form13'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE wednesday_schedule SET image7=? WHERE wednesday_schedule_id=1");
        $statement->execute(array($final_name));
        $success_message = 'schedule image is succesfully updated.';
...
if(isset($_POST['form15'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE wednesday_schedule SET image8=? WHERE wednesday_schedule_id=1");
        $statement->execute(array($final_name));
        $success_message = 'schedule image is succesfully updated.';
...
if(isset($_POST['form2'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE wednesday_schedule SET time1=?, class1=?, name1=? WHERE wednesday_schedule_id=1");
    $statement->execute(array($_POST['time1'],$_POST['name1'],$_POST['class1']));
...
if(isset($_POST['form4'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE wednesday_schedule SET time2=?, class2=?, name2=? WHERE wednesday_schedule_id=1");
    $statement->execute(array($_POST['time2'],$_POST['name2'],$_POST['class2']));
    $success_message = 'General content settings is updated successfully.';
...
if(isset($_POST['form6'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE wednesday_schedule SET time3=?, class3=?, name3=? WHERE wednesday_schedule_id=1");
    $statement->execute(array($_POST['time3'],$_POST['name3'],$_POST['class3']));
    $success_message = 'General content settings is updated successfully.';
...
if(isset($_POST['form8'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE wednesday_schedule SET time4=?, class4=?, name4=? WHERE wednesday_schedule_id=1");
    $statement->execute(array($_POST['time4'],$_POST['name4'],$_POST['class4']));
    $success_message = 'General content settings is updated successfully.';
...
if(isset($_POST['form10'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE wednesday_schedule SET time5=?, class5=?, name5=? WHERE wednesday_schedule_id=1");
    $statement->execute(array($_POST['time5'],$_POST['name5'],$_POST['class5']));
    $success_message = 'General content settings is updated successfully.';
...
if(isset($_POST['form12'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE wednesday_schedule SET time6=?, class6=?, name6=? WHERE wednesday_schedule_id=1");
    $statement->execute(array($_POST['time6'],$_POST['name6'],$_POST['class6']));
    $success_message = 'General content settings is updated successfully.';
...
if(isset($_POST['form14'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE wednesday_schedule SET time7=?, class7=?, name7=? WHERE wednesday_schedule_id=1");
    $statement->execute(array($_POST['time7'],$_POST['name7'],$_POST['class7']));
    $success_message = 'General content settings is updated successfully.';
    
}

if(isset($_POST['form16'])) {
    
    // updating the database
    $statement = $pdo->prepare("UPDATE wednesday_schedule SET time8=?, class8=?, name8=? WHERE wednesday_schedule_id=1");
    $statement->execute(array($_POST['time8'],$_POST['name8'],$_POST['class8']));
    $success_message = 'General content settings is updated successfully.';
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6" style="padding-top:6px;">
                                                <img src="../images/scheduleImages/<?php echo $image1; ?>"
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Existing Photo</label>
                                            <div class="col-sm-6" style="padding-top:6px;">
                                                <img src="../images/scheduleImages/<?php echo $image2; ?>"
                                                    class="existing-photo" style="height:80px;">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <button type="submit" class="btn btn-success pull-left"
                                                    name="form3">Update schedule image2</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <button type="submit" class="btn btn-success pull-left"
                                                    name="form5">Update schedule image3</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Existing Photo</label>
                                            <div class="col-sm-6" style="padding-top:6px;">
                                                <img src="../images/scheduleImages/<?php echo $image4; ?>"
                                                    class="existing-photo" style="height:80px;">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <button type="submit" class="btn btn-success pull-left"
                                                    name="form7">Update schedule image4</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <button type="submit" class="btn btn-success pull-left"
                                                    name="form9">Update schedule image5</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <button type="submit" class="btn btn-success pull-left"
                                                    name="form11">Update schedule image6</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <button type="submit" class="btn btn-success pull-left"
                                                    name="form13">Update schedule image7</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <button type="submit" class="btn btn-success pull-left"
                                                    name="form15">Update schedule image8</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
