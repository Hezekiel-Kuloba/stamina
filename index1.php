			...
			<div class="col-md-8 col-md-offset-2 text-center">
				<div class="display-t">
					<div class="display-tc animate-box" data-animate-effect="fadeIn">
						...
						<h2>
							<?php echo $backgroundimage_text2; ?> <a href="#" target="_blank">
								<?php echo $backgroundimage_text3; ?>
							</a>
						</h2>
		...
		<div class="row">
			<div class="col-md-4 text-center animate-box">
				<div class="services">
					...
					<p><a href="#" class="btn btn-primary btn-outline btn-sm">More <i class="icon-arrow-right"></i></a>
					</p>
				</div>
			</div>
			<div class="col-md-4 text-center animate-box">
...
<div id="fh5co-schedule" class="fh5co-bg" style="background-image: url(images/img_bg_2.jpg);">
	<div class="container">
		<div class="row">
